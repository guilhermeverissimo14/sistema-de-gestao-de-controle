...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Dez-2022 às 13:30
...
CREATE TABLE `user` (
  ...
  `token` varchar(255) NOT NULL DEFAULT current_timestamp(),
...
(78, 'Mariana', '@Mariana', '12345', 'current_timestamp()', 2),
(7888, 'Mariana', '@Mariana', '12345', 'current_timestamp()', 2);
...
--
ALTER TABLE `user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7889;
COMMIT;
